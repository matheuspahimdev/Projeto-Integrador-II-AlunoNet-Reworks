...
class NavBar extends HTMLElement{
  ...
  static ITEMS = [
    ...
    { label: 'Protocolo',  icon: 'bi-graph-up-arrow',
      subs: [{ label: 'Central Protocolo', href: '#' }] },
    ...
    { label: 'Avisos',     icon: 'bi-envelope',
      subs: [{ label: 'Feed Avisos', href: '#' }] },
    { label: 'Biblioteca', icon: 'bi-bookshelf',
      subs: [{ label: 'Central Biblioteca', href: '#' }] },
    { label: 'Eventos',    icon: 'bi-calendar-event',
      subs: [{ label: 'Central Eventos', href: '#' }] },
